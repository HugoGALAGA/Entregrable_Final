'''
Binary Search Tree - Worst Case Scenario Generation
'''
...
class BinarySearchTree:
    ...
    def timed_search(self, key: int) -> tuple[bool, float]:
        """
        Searches for a key in the BST and measures the execution time.
        """
    ...
    def insert_worst_case(self, num_nodes: int):
        """
        Inserts nodes in ascending order to create a worst-case (skewed) BST.
        """
        for i in range(1, num_nodes + 1): # Insert values 1, 2, 3, ..., num_nodes
            self.insert(i)